<script>
  ...
  $: availableRooms = allAvailableRooms.filter(
    (r) => r.room_type !== "common" && !r.occupied && r.id !== currentRoom?.id
  );
...
{#if tenant}
  <Modal bind:open title="Mover Inquilino" size="md">
    <div class="space-y-4">
      ...
      <div
        class="bg-gradient-to-r from-orange-50/50 to-pink-50/50 dark:from-orange-900/20 dark:to-pink-900/20 border border-orange-200/50 dark:border-orange-800/50 rounded-2xl p-5"
      >
        <div class="flex items-center justify-center gap-4">
          <div class="text-center">
            ...
            <div
              class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm px-5 py-2.5 rounded-xl shadow-sm"
            >
              <p class="text-sm font-bold text-gray-800 dark:text-gray-200">
                {currentRoom?.name || "Sin habitación"}
              </p>
            </div>
          </div>
        ...
        <div
          class="text-center mt-4 pt-4 border-t border-orange-200/50 dark:border-orange-800/50"
        >
      ...
      <div>
          ...
          <div class="flex items-center justify-between">
            <h3 class="font-semibold text-gray-900 dark:text-gray-100">
              ...
              {#if availableRooms.length > 0}
                <span
                  class="ml-2 px-2 py-0.5 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-xs rounded-full"
                >
            ...
            <label class="flex items-center gap-2 cursor-pointer group">
              ...
              />
              <span
                class="text-xs text-gray-600 dark:text-gray-400 group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors"
              >
              ...
              >
                <div class="flex items-center justify-between">
                  ...
                  {#if selectedRoomId === room.id}
                    <div
                      class="w-6 h-6 rounded-full bg-orange-500 flex items-center justify-center shadow-sm"
                    >
                      <svg
        ...
        {:else}
          <div
            class="text-center py-10 bg-white/60 dark:bg-gray-800 rounded-2xl border border-gray-200/50 dark:border-gray-700/50"
          >
            <div
              class="inline-flex p-3 bg-white/80 dark:bg-gray-700 rounded-full mb-3"
            >
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">
              {#if showAllProperties}
                Todas las habitaciones de todas tus propiedades están ocupadas o
                son salas comunes
              {:else}
                Todas las habitaciones de esta propiedad están ocupadas o son
                salas comunes
                <br />
                <button
